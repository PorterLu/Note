...
int main( int argc, char* args[] )
{
    ...
    while( quit == false )
    {
        ...
        /*for 20 frames in a second, each frame needs to run 50 millseconds. Therefore, if a cycle is less than 
        50 millseconds, you have to wait until 50 millseconds.
        */
